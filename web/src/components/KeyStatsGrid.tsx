    ...
    <div className="rounded-md border border-border bg-panel">
      ...
      <dl className="grid grid-cols-2 sm:grid-cols-3">
        {stats.map((s) => (
          <div
            key={s.label}
            className="border-b border-r border-border p-4 last:border-b-0 [&:nth-child(3n)]:sm:border-r-0 [&:nth-last-child(-n+2)]:border-b-0 sm:[&:nth-last-child(-n+3)]:border-b-0"
          >
            ...
            <dd className="text-[11px] text-muted">{s.hint}</dd>
          </div>
        ))}
      </dl>
    </div>
